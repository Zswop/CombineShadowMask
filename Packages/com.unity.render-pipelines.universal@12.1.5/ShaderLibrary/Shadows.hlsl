...
#define SHADOWMASK_SAMPLE_EXTRA_ARGS
    ...
    #if defined(LIGHTMAP_SHADOWMASK_COMBINED)
        #define SAMPLE_SHADOWMASK(uv) half4(SAMPLE_TEXTURE2D_LIGHTMAP(LIGHTMAP_NAME, LIGHTMAP_SAMPLER_NAME, uv SHADOWMASK_SAMPLE_EXTRA_ARGS).a, 1, 1, 1);
    #else
